                        ...
                        <div class="form-body">
                            ...
                            <form class="register-form" action="<?= base_url() ?>admin/admins/create" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input class="form-control" type="text" placeholder="Имя" value="" name="name"
                                               id="name"/>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php if (isset($_POST['surname'])): ?>
                                        <input class="form-control" type="text" placeholder="Фамилия"
                                               value="<?= $_POST['surname'] ?>" name="surname" id="surname"/>
                                    <?php else: ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (isset($_POST['email'])): ?>
                                        <input class="form-control" type="text" placeholder="Электронная почта"
                                               value="<?= $_POST['email'] ?>" name="email" id="email"/>
                                    <?php else: ?>
                                        <input class="form-control" type="text" placeholder="Электронная почта"
                                               name="email" id="email"/>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (isset($_POST['phone_number'])): ?>
                                        <input class="form-control" type="text" placeholder="Номер мобильного телефона"
                                               value="<?= $_POST['phone_number'] ?>" name="phone_number"
                                               id="phone_number"/>
                                    <?php else: ?>
                                        <input class="form-control" type="text" placeholder="Номер мобильного телефона"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (isset($_POST['login'])): ?>
                                        <input class="form-control" type="text" autocomplete="off"
                                               value="<?= $_POST['login'] ?>" placeholder="Логин" name="login"
                                               id="login"/>
                                    <?php else: ?>
                                        <input class="form-control" type="text" autocomplete="off" placeholder="Логин"
                                               name="login" id="login"/>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="password" autocomplete="off"
                                           id="register_password" placeholder="Пароль" name="password"/>
                                </div>
                                <div class="form-group">
