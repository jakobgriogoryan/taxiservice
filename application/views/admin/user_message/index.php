            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-user"></i> Сообщение пользователя
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover datatable">
                            ...
                            <?php foreach ($contacts as $contact): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?= $contact->date ?></td>
                                    <td>
                                        <button title="Удалить" class="delete-message" type="submit"
                                                data-id="<?= $contact->id ?>"><i class="fa fa-remove"></i>
                                        </button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
